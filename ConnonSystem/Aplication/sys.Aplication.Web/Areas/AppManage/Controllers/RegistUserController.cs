...
namespace sys.Application.Web.Areas.AppManage.Controllers
{
    ...
    /// 描 述：用户管理
    /// </summary>
    public class RegistUserController : MvcControllerBase
    {
        private RegisterUserBLL userBLL = new RegisterUserBLL();
        ...
        public ActionResult GetListJson(string organizeId)
        {
            ...
            {
                data = data.Where(t => t.OrganizeId == organizeId && t.EnabledMark == 1 && t.VerifyMark == 1);
            }
        ...
        [ValidateAntiForgeryToken]
        [AjaxOnly]
        public ActionResult SaveReviseAudit(string keyValue, int verifyMark, string verifyDescribe)
        { 
            userBLL.SaveReviseAudit(keyValue, verifyMark,verifyDescribe);
            return Success("操作成功");
        }
        /// <summary>
        /// 禁用账户
