...
var vars = {
    jsPath: '/Content/scripts/survey/resources/script/',
    jsTmp: '/Content/scripts/survey/resources/script/artTemplate/',
    cssPath: '/Content/scripts/survey/resources/skin/',
    isLayer: '/Content/scripts/survey/resources/script/layer/'
};
