...
function(n, t) {
    ...
    n.fn.comboBoxTree = function(i) {
        ...
        f = {
            ...
            loadData: function(i) {
                ...
                function(n, t) {
                    var r = top.sys.data.get(["dataItem", i.dataItemName, t[i.text]]);
                    r != "" && (t[i.text] = r);
                    i.data.push(t)
                })) : i.data = r
            },
    ...
    n.fn.authorizeButton = function() {
        ...
        r = top.sys.data.get(["authorizeButton", u]);
    ...
    n.fn.authorizeColModel = function() {
        ...
        t = top.sys.data.get(["authorizeColumn", u]);
...
formatDate = function(n, t) {
    return sys.formatDate(n, t)
};
toDecimal = function(n) {
    return sys.toDecimal(n)
};
request = function(n) {
    return sys.request(n)
};
changeUrlParam = function(n, t, i) {
    return sys.changeUrlParam(n, t, i)
};
$.currentIframe = function() {
    return sys.currentIframe()
};
$.isbrowsername = function() {
    return sys.isbrowsername()
};
...
$.isNullOrEmpty = function(n) {
    return sys.isNullOrEmpty(n)
};
IsNumber = function(n) {
    return sys.isNumber(n)
};
IsMoney = function(n) {
    return sys.isMoney(n)
};
$.arrayClone = function(n) {
    return sys.arrayCopy(n)
};
$.windowWidth = function() {
    return $(window).width()
};
...
checkedArray = function(n) {
    return sys.checkedArray(n)
};
checkedRow = function(n) {
    return sys.checkedRow(n)
};
$(function() {
